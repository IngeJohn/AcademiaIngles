...
require_once 'utilities/contra.entidad.php';
require_once 'utilities/contra.model.php';

// Logica
$alm = new contra();
$model = new contraModel();

if(isset($_REQUEST['action']))
{
    if(isset($_REQUEST['password'])){
        
        if(strlen($_REQUEST['password'])!=60){
            
        $param_contrase = password_hash($_REQUEST['password'], PASSWORD_DEFAULT);
            
        }else{

            $param_contrase = $_REQUEST['password'];
	...
	switch($_REQUEST['action'])
	{
		case 'actualizar':
			...
			$alm->__SET('password',        $param_contrase);

			$model->Actualizar($alm);
			header('Location: adminContra.php');
			break;
...
<head>
    <meta charset="UTF-8">
    <title>Modificar Contraseñas Docentes</title>
...
<body>
            ...
            <div class="row">
                    ...
                    <div class="col-sm-12" style="text-align: center;">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <a href="adminContra.php" class="btn btn-outline-light active" role="button" >Modificar Contraseña Docentes</a>
    ...
    <div class="container">
        ...
        <div class="col-sm-6" style="font-size:16px;">
              ...
              <div>  
                  <p>Modificar Contraseña Docentes</p>
                <form action="?action=actualizar&idmaestro" method="post" onsubmit="return confirm('Presiona OK para continuar.');">
                    ...
                    <table class="table table-bordered table-dark table-sm"  >
                        ...
                        <tr>
                           ...
                           <td> 
                               <input onClick="this.select();" type="password" name="password" class="form-control" value="<?php  echo $alm->__GET('password');?>">
                            </td>
                        ...
                        <tr>
                            <td><?php echo $alm->__GET('idmaestro'); ?></td>
                            <td>
                ...
                <table class="table table-bordered table-dark table-sm"  id="myTable" >
                    ...
                    <tbody id="tab-id" style="text-align:center;">
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-success btn-sm" href="?action=editar&idmaestro=<?php echo $r->idmaestro; ?>">Seleccionar</a>
                            </td>
                        </tr>
                    </tbody>
