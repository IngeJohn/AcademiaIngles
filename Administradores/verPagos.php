...
<body>
            ...
            <div class="row">
                    ...
                    <div class="col-sm-12" style="text-align: center;">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <a href="verPagos.php" class="btn btn-outline-light active" role="button" >Pagos Inscripción</a>
                            
                            <a href="verPagosLibro.php" class="btn btn-outline-light" role="button" >Pagos Libro</a>
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body" style="padding:35px;">
                ...
                <p>Puedes utilizar el filtro para buscar por: nivel, grupo, carrera y modalidad.</p>
    ...
    <div class="container">
        ...
        <div class="col-sm-12"style="font-size:16px;">
            <h2>Registro de Pago de Inscripciones - Periodo: <?php echo $_SESSION['periodoBD'];  ?></h2>
            <div>
                ...
                <table class="table table-bordered table-dark"  id="myTable" >
                    ...
                    <tbody id="tab-id" style="text-align:center;">
                        <tr>
                            ...
                            <td><?php echo $r->__GET('inscripcionPagoEstado'); ?></td>
                            <td>
