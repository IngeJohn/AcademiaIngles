...
$username = $password = $category = $numeroEmpleado = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, username, password, category, numeroEmpleado FROM administradores WHERE username = ?";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    mysqli_stmt_bind_result($stmt, $id, $username, $hashed_password, $category, $numeroEmpleado);
            ...
            <div class="col-sm-5">
                <div class="p-3 mb-2 bg-light text-dark">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <p>Acerca de Academia de Inglés ITSL <a href="acercaDe.html"><u>aquí</u></a>.</p>
                    </form>
                </div>
