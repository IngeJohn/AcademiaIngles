...
if(isset($_REQUEST['action']))
{
	switch($_REQUEST['action'])
	{
		case 'actualizar':
			...
			header('Location: adminAlumnRegis.php');
			break;
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body" style="padding:35px;">
                ...
                <p>En la tabla de la derecha se muestra un listado de alumnos, selecciona alguno dando clic en el botón verde que corresponde a cada alumno para cargar la información en el lado izquierdo.</p>
                  ...
                  <table class="table table-sm">
                        <tr>
                          ...
                          <td>
                              ...
                              <?php echo $alm->__GET('nombre')." ".$alm->__GET('paterno')." ".$alm->__GET('materno');?>
            ...
            <div>
             ...
             <div class=" ex3">  
                ...
                <table class="table table-bordered table-dark table-sm"  id="myTable" >
                    ...
                    <?php foreach($model->Listar5() as $r): ?>
