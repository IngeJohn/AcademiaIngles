...
require_once "pdfdatos.php";
    ...
    for($i=0; $i <= 60; $i++){
        ...
        if(isset($numeros9[$i])){
            ...
            if($dataRow9[2] === 'Industrial'){
                $carre = "IND";
            }elseif($dataRow9[2] === 'Gestión Empresarial'){
                $carre = "IGE";
            }elseif($dataRow9[2] === 'Sistemas Computacionales'){
                $carre = "ISC";
            }elseif($dataRow9[2] === 'Mecatrónica'){
                $carre = "MECA";
            }
            
            $nombres = $nombres."<tr>
                                    <td class='inte' style='text-align:center;'>$numero</td>    
                                    <td class='inte'>".alumnos($numeros9[$i],$dataRow9[5], $link)."</td>
                                    <td class='inte' style='text-align:center;'>$numeros9[$i]</td>
                                    <td class='inte' style='text-align:center;'> $carre / $dataRow9[0] / $dataRow9[1] </td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
