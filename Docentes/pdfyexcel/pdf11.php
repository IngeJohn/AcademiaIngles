...
require_once "pdfdatos.php";
    ...
    for($i=0; $i <= 60; $i++){
        ...
        if(isset($numeros12[$i])){
            ...
            if($dataRow12[2] === 'Industrial'){
                $carre = "IND";
            }elseif($dataRow12[2] === 'Gestión Empresarial'){
                $carre = "IGE";
            }elseif($dataRow12[2] === 'Sistemas Computacionales'){
                $carre = "ISC";
            }elseif($dataRow12[2] === 'Mecatrónica'){
                $carre = "MECA";
            }
            
            $nombres = $nombres."<tr>
                                    <td class='inte' style='text-align:center;'>$numero</td>    
                                    <td class='inte'>".alumnos($numeros12[$i],$dataRow12[5], $link)."</td>
                                    <td class='inte' style='text-align:center;'>$numeros12[$i]</td>
                                    <td class='inte' style='text-align:center;'> $carre / $dataRow12[0] / $dataRow12[1] </td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
