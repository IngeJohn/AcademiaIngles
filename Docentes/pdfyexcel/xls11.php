...
if(isset($dataRow12[0])){$titulo = $dataRow12[0]."-".$dataRow12[1]."-".$dataRow12[2]."-".$dataRow12[3]."-".$dataRow12[4];
...
echo utf8_decode("\nLista de Alumos de ".$dataRow12[0].$dataRow12[1]. " de la carrera de Ingeniería (en) ".$dataRow12[2]." | Modalidad: ".$dataRow12[3]." | Periodo: ".$dataRow12[4]." \n");
...
echo utf8_decode("\nNombre del alumno\tNúmero de Control\n");
    ...
    for($i=0; $i <= 60; $i++){
        ...
        if(isset($numeros12[$i])){
            ...
            echo utf8_decode(alumnos($numeros12[$i],$dataRow12[0], $link)."\t".$numeros12[$i]. "\n");
