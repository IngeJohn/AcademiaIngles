...
require_once "pdfdatos.php";
    ...
    for($i=0; $i <= 60; $i++){
        ...
        if(isset($numeros1[$i])){
            ...
            if($dataRow1[2] === 'Industrial'){
                $carre = "IND";
            }elseif($dataRow1[2] === 'Gestión Empresarial'){
                $carre = "IGE";
            }elseif($dataRow1[2] === 'Sistemas Computacionales'){
                $carre = "ISC";
            }elseif($dataRow1[2] === 'Mecatrónica'){
                $carre = "MECA";
            }
            
            $nombres = $nombres."<tr>
                                    <td class='inte' style='text-align:center;'>$numero</td>    
                                    <td class='inte'>".alumnos($numeros1[$i],$dataRow1[5], $link)."</td>
                                    <td class='inte' style='text-align:center;'>$numeros1[$i]</td>
                                    <td class='inte' style='text-align:center;'> $carre / $dataRow1[0] / $dataRow1[1] </td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
