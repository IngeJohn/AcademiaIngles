...
require_once "pdfdatos.php";
    ...
    for($i=0; $i <= 60; $i++){
        ...
        if(isset($numeros8[$i])){
            ...
            if($dataRow8[2] === 'Industrial'){
                $carre = "IND";
            }elseif($dataRow8[2] === 'Gestión Empresarial'){
                $carre = "IGE";
            }elseif($dataRow8[2] === 'Sistemas Computacionales'){
                $carre = "ISC";
            }elseif($dataRow8[2] === 'Mecatrónica'){
                $carre = "MECA";
            }
            
            $nombres = $nombres."<tr>
                                    <td class='inte' style='text-align:center;'>$numero</td>    
                                    <td class='inte'>".alumnos($numeros8[$i],$dataRow8[5], $link)."</td>
                                    <td class='inte' style='text-align:center;'>$numeros8[$i]</td>
                                    <td class='inte' style='text-align:center;'> $carre / $dataRow8[0] / $dataRow8[1] </td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
