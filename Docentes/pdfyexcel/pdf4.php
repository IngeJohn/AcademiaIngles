...
require_once "pdfdatos.php";
    ...
    for($i=0; $i <= 60; $i++){
        ...
        if(isset($numeros5[$i])){
            ...
            if($dataRow5[2] === 'Industrial'){
                $carre = "IND";
            }elseif($dataRow5[2] === 'Gestión Empresarial'){
                $carre = "IGE";
            }elseif($dataRow5[2] === 'Sistemas Computacionales'){
                $carre = "ISC";
            }elseif($dataRow5[2] === 'Mecatrónica'){
                $carre = "MECA";
            }
            
            $nombres = $nombres."<tr>
                                    <td class='inte' style='text-align:center;'>$numero</td>    
                                    <td class='inte'>".alumnos($numeros5[$i],$dataRow5[5], $link)."</td>
                                    <td class='inte' style='text-align:center;'>$numeros5[$i]</td>
                                    <td class='inte' style='text-align:center;'> $carre / $dataRow5[0] / $dataRow5[1] </td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
