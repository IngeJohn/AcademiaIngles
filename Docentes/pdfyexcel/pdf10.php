...
require_once "pdfdatos.php";
    ...
    for($i=0; $i <= 60; $i++){
        ...
        if(isset($numeros11[$i])){
            ...
            if($dataRow11[2] === 'Industrial'){
                $carre = "IND";
            }elseif($dataRow11[2] === 'Gestión Empresarial'){
                $carre = "IGE";
            }elseif($dataRow11[2] === 'Sistemas Computacionales'){
                $carre = "ISC";
            }elseif($dataRow11[2] === 'Mecatrónica'){
                $carre = "MECA";
            }
            
            $nombres = $nombres."<tr>
                                    <td class='inte' style='text-align:center;'>$numero</td>    
                                    <td class='inte'>".alumnos($numeros11[$i],$dataRow11[5], $link)."</td>
                                    <td class='inte' style='text-align:center;'>$numeros11[$i]</td>
                                    <td class='inte' style='text-align:center;'> $carre / $dataRow11[0] / $dataRow11[1] </td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
