...
require_once "pdfdatos.php";
    ...
    for($i=0; $i <= 60; $i++){
        ...
        if(isset($numeros2[$i])){
            ...
            if($dataRow2[2] === 'Industrial'){
                $carre = "IND";
            }elseif($dataRow2[2] === 'Gestión Empresarial'){
                $carre = "IGE";
            }elseif($dataRow2[2] === 'Sistemas Computacionales'){
                $carre = "ISC";
            }elseif($dataRow2[2] === 'Mecatrónica'){
                $carre = "MECA";
            }
            
            $nombres = $nombres."<tr>
                                    <td class='inte' style='text-align:center;'>$numero</td>    
                                    <td class='inte'>".alumnos($numeros2[$i],$dataRow2[5], $link)."</td>
                                    <td class='inte' style='text-align:center;'>$numeros2[$i]</td>
                                    <td class='inte' style='text-align:center;'> $carre / $dataRow2[0] / $dataRow2[1] </td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
