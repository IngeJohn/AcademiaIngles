...
require_once "pdfdatos.php";
    ...
    for($i=0; $i <= 60; $i++){
        ...
        if(isset($numeros6[$i])){
            ...
            if($dataRow6[2] === 'Industrial'){
                $carre = "IND";
            }elseif($dataRow6[2] === 'Gestión Empresarial'){
                $carre = "IGE";
            }elseif($dataRow6[2] === 'Sistemas Computacionales'){
                $carre = "ISC";
            }elseif($dataRow6[2] === 'Mecatrónica'){
                $carre = "MECA";
            }
            
            $nombres = $nombres."<tr>
                                    <td class='inte' style='text-align:center;'>$numero</td>    
                                    <td class='inte'>".alumnos($numeros6[$i],$dataRow6[5], $link)."</td>
                                    <td class='inte' style='text-align:center;'>$numeros6[$i]</td>
                                    <td class='inte' style='text-align:center;'> $carre / $dataRow6[0] / $dataRow6[1] </td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
                                    <td class='inte'></td>
