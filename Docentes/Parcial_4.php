...
function calificaciones($numCon,$idg){
    ...
    if ($stmtg = $link->prepare("SELECT fechaInicio, fechaTermino FROM parcialfechas WHERE numeroParcial = 4")) {
        ...
        $stmtg->close();
            ...
            if ($stmt3 = $link->prepare("SELECT idparcialFechas FROM parcialfechas WHERE numeroParcial = 4")) {
            ...
            <div class="row">
                    ...
                    <div class="col-sm-12" style="text-align: center;">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <a href="Parcial_4.php" class="btn btn-outline-light active" role="button" >Parcial 4</a>
              ...
              <div>  
                <form action="?action=<?php echo $alm->id > 0 ? 'actualizar' : 'registrar'; ?>" method="post" onsubmit="return confirm('Presiona OK para continuar.');">
                    ...
                    <table class="table table-bordered table-dark table-sm"  >
                        ...
                        <tr>
                            <th colspan="4" style="text-align:center;">Unidades del Cuarto Parcial</th>
                        </tr>
                        ...
                        <?php echo calificaciones($alm->__GET('numeroControl'),$alm->__GET('idgrupo'));  ?>
                         ...
                         <tr>
                            <td colspan="4" style="text-align:right;">
                                <a href="Parcial_4.php" class="btn btn-light btn-sm">Limpiar campos</a> &nbsp;&nbsp;&nbsp;
            ...
            <div>
             ...
             <div class=" ex3">  
                ...
                <table class="table table-bordered table-dark table-sm"  id="myTable" >
                    ...
                    <?php foreach($model->Listar(4) as $r): ?>
            ...
            <div>
             ...
             <div class=" ex3">  
                ...
                <table class="table table-bordered table-dark table-sm"  id="myTable" >
                    ...
                    <?php foreach($model->Listar3(4) as $r): ?>
