...
if ($stmtfe = $link->prepare("SELECT fechaInicio, fechaTermino FROM parcialfechas WHERE numeroParcial = 4")) {
...
<body>
                ...
                <div class="col-sm-4" style="text-align:center; padding-top:20px; ">
                    ...
                    <div class="col-sm-12" style="text-align: center;">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <a href="Reportes_4.php" class="btn btn-outline-light active" role="button" >Reporte 4</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <br>
                <a target='_blank' href="ReportesPrint_4.php" class="btn btn-primary active" role="button" >Versión para imprimir</a>
                <h1>Reporte Parcial</h1>
                <h2>INSTITUTO TECNOLÓGICO SUPERIOR DE LORETO</h2>
                <h3>SUBDIRECCIÓN ACADÉMICA</h3>
                
                <p><b>DEPARTEMENTO DE: </b></p>
                <p><b>REPORTE PARCIAL: 4 | DEL SEMESTRE: <?php if($per == 1){echo "ene-jun ".$year;}elseif($per == 2){echo  "ago-dic ".$year;} ?> </b></p>
