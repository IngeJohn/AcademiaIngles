...
function calificaciones($numCon,$idg){
    ...
    $query = "SELECT unidadTema, calificacion, oportunidad, fecha, oportunidad FROM calificaciones WHERE idgrupo = '$idg' AND numeroControl = '$numCon' AND 
            ...
            <div class="row">
                    ...
                    <div class="col-sm-12" style="text-align: center;">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <a href="Parciales.php" class="btn btn-outline-light active" role="button" >Parcial 1</a>
              ...
              <div>  
                <form action="?action=<?php echo $alm->id > 0 ? 'actualizar' : 'registrar'; ?>" method="post" onsubmit="return confirm('Presiona OK para continuar.');">
                    ...
                    <table class="table table-bordered table-dark table-sm"  >
                        ...
                        <tr>
                            <th colspan="4" style="text-align:center;">Unidades del primer parcial</th>
                        </tr>
                        ...
                        <?php echo calificaciones($alm->__GET('numeroControl'),$alm->__GET('idgrupo'));  ?>
                         ...
                         <tr>
                            <td colspan="4" style="text-align:right;">
                                <a href="Parciales.php" class="btn btn-light">Limpiar campos</a> &nbsp;&nbsp;&nbsp;
                        ...
                        <div>
                         ...
                         <div class=" ex3">  
                            ...
                            <table class="table table-bordered table-dark table-sm"  id="myTable" >
                                ...
                                <?php foreach($model->Listar(1) as $r): ?>
                        ...
                        <input type="text" id="myInput2" class="form-control" placeholder="Parciales calificados...">
                             ...
                             <div class=" ex3">  
                                ...
                                <table class="table table-bordered table-dark table-sm"  id="myTable" >
                                    ...
                                    <?php foreach($model->Listar3(1) as $r): ?>
