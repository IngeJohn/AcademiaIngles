...
function talumnospormateria2aOp($idg,$uniT){
    ...
    if ($stmt = $link->prepare("SELECT COUNT(calificaciones2.numeroControl) 
                                FROM calificaciones2, gruposasignados, alumnos WHERE gruposasignados.idgrupo = '$idg' 
                                AND gruposasignados.idgrupo = calificaciones2.idgrupo 
                                AND alumnos.numeroControl = calificaciones2.numeroControl
                                AND calificaciones2.oportunidad = '2aOp' 
                                AND calificaciones2.calificacion >= 70 AND calificaciones2.unidadTema = '$uniT'
                                AND alumnos.altabaja = 'Alta';")) {
    $stmt->execute();
    ...
    $stmt->close();
                ...
                //Alumnos despues
                //=============================================
                    if ($stmt2 = $link->prepare("SELECT COUNT(altasbajas.numeroControl) FROM altasbajas, calificaciones2, gruposasignados WHERE altasbajas.fecha > '$termino' 
                                                    AND calificaciones2.idgrupo = '$idg' 
                                                    AND altasbajas.numeroControl = calificaciones2.numeroControl
                                                    AND gruposasignados.idgrupo = calificaciones2.idgrupo
                                                    AND calificaciones2.unidadTema = '$uniT' 
                                                    AND altasbajas.altaBaja = 'Baja'  AND calificaciones2.oportunidad = '2aOp' AND calificaciones2.calificacion >= 70;")) {
...
function talumnosrepro1ay2aOp($idg, $uniT){
    ...
    if ($stmt3 = $link->prepare("SELECT COUNT(calificaciones2.numeroControl) 
                                FROM calificaciones2, gruposasignados, alumnos WHERE gruposasignados.idgrupo = '$idg' 
                                AND gruposasignados.idgrupo = calificaciones2.idgrupo 
                                AND alumnos.numeroControl = calificaciones2.numeroControl
                                AND calificaciones2.oportunidad = '2aOp' 
                                AND calificaciones2.calificacion <= 69 AND calificaciones2.unidadTema = '$uniT'
                                AND alumnos.altabaja = 'Alta';")) {
    $stmt3->execute();
    ...
    $stmt3->close();
                ...
                //Alumnos despues
                //=============================================
                    if ($stmt4 = $link->prepare("SELECT COUNT(altasbajas.numeroControl) FROM altasbajas, calificaciones2, gruposasignados WHERE altasbajas.fecha > '$termino' 
                                                    AND calificaciones2.idgrupo = '$idg' 
                                                    AND altasbajas.numeroControl = calificaciones2.numeroControl
                                                    AND gruposasignados.idgrupo = calificaciones2.idgrupo
                                                    AND calificaciones2.unidadTema = '$uniT' 
                                                    AND altasbajas.altaBaja = 'Baja'  AND calificaciones2.oportunidad = '2aOp' AND calificaciones2.calificacion <= 69;")) {
...
<body>
                ...
                <div class="col-sm-4" style="text-align:center; padding-top:20px; ">
                    ...
                    <div class="col-sm-12" style="text-align: center;">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <a href="Reportes_final.php" class="btn btn-outline-light active" role="button" >Reporte Final</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <br>
                <a target='_blank' href="ReportesPrint_final.php" class="btn btn-primary active" role="button" >Versión para imprimir</a>
