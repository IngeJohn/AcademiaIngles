...
function calificaciones($numCon,$idg){
    ...
    $unitem = $califi = $idparfe = $opor = $fech = "";
    ...
    if ($stmtg = $link->prepare("SELECT fechaInicio, fechaTermino FROM parcialfechas WHERE numeroParcial = 5")) {
        ...
        $stmtg->close();
            ...
            if ($stmt3 = $link->prepare("SELECT idparcialFechas FROM parcialfechas WHERE numeroParcial = 'FINAL'")) {
            ...
            if ($stmtk = $link->prepare("SELECT  calificacion, unidades, id, oportunidad, fecha FROM parciales WHERE idparcialFecha = '{$idparfe}' AND numeroControl = '{$numCon}'")) {
                
                $stmtk->execute();

                /* bind variables to prepared statement */
                $stmtk->bind_result($califi,$unitem, $id, $opor, $fech);
    ...
    $query = "SELECT parcialfechas.numeroParcial, parciales.calificacion, parciales.oportunidad, parciales.fecha FROM parciales, parcialfechas WHERE idgrupo = '$idg' AND numeroControl = '$numCon' AND parcialfechas.idparcialFechas = parciales.idparcialFecha ";
            ...
            <div class="row">
                    ...
                    <div class="col-sm-12" style="text-align: center;">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <a href="Parcial_2.php" class="btn btn-outline-light " role="button" >Parcial 2</a>
                            ...
                            <a href="Final.php" class="btn btn-outline-light active" role="button" >Final</a>
                ...
                <form action="?action=<?php echo $alm->id > 0 ? 'actualizar' : 'registrar'; ?>" method="post" onsubmit="return confirm('Presiona OK para continuar.');">
                    ...
                    <table class="table table-bordered table-dark table-sm"  >
                        <tr>
                            ...
                            <th colspan="2">Inforgamción del Grupo</th>
                        ...
                        <tr>
                            <th colspan="4" style="text-align:center;">Parciales</th>
                        </tr>
                        ...
                        <?php echo calificaciones($alm->__GET('numeroControl'),$alm->__GET('idgrupo'));  ?>
                         ...
                         <tr>
                            <td colspan="4" style="text-align:right;">
                                <a href="Final.php" class="btn btn-light btn-sm">Limpiar campos</a> &nbsp;&nbsp;&nbsp;
            ...
            <div>
             ...
             <div class=" ex3">  
                ...
                <table class="table table-bordered table-dark table-sm"  id="myTable" >
                    ...
                    <?php foreach($model->Listar(5) as $r): ?>
            ...
            <div>
             ...
             <div class=" ex3">  
                ...
                <table class="table table-bordered table-dark table-sm"  id="myTable" >
                    ...
                    <?php foreach($model->Listar3(5) as $r): ?>
